detect_and_classify.py - Reads a video stream with cv2 and runs each frame through Mobilenet-v2 Object detection network and pytorch image classification network
